...
export default function PatientDetails({ patientId }: { patientId: string }) {
      ...
      <Card>
        <CardContent className="p-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600">O paciente solicitado não foi encontrado no sistema.</p>
  ...
  const formattedBirthDate = birthDate
    ? format(parseISO(patient.birth_date.split("T")[0]), "dd/MM/yyyy", { locale: ptBR })
    : "Não informado"
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="mt-2 space-y-2">
                      <p>
                        <span className="font-medium">Rua:</span> {patient.street}
                      </p>
                      <p>
                        <span className="font-medium">CEP:</span> {patient.zip_code}
                      </p>
                      <p>
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-2">
                      <p>
                        <span className="font-medium">Possui Convênio:</span> {patient.has_insurance ? "Sim" : "Não"}
                      </p>
                      {patient.has_insurance && (
                        <>
                          <p>
                            <span className="font-medium">Convênio:</span> {patient.insurance_name || "Não informado"}
                          </p>
                          <p>
                            <span className="font-medium">Número:</span> {patient.insurance_number || "Não informado"}
                          </p>
                        </>
                      )}
                    </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>Histórico de tratamentos do paciente</CardDescription>
              </div>
              <Button onClick={handleCreateTreatment} disabled={isCreatingTreatment}>
