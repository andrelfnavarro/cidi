...
export default function PatientSearch() {
  ...
  const onSubmit = async (data: z.infer<typeof searchSchema>) => {
    try {
      ...
      toast({
        title: "Erro",
        description: error instanceof Error ? error.message : "Erro ao buscar paciente. Tente novamente.",
        variant: "destructive",
      })
    } finally {
      setIsLoading(false)
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Digite o CPF do paciente para acessar suas informações</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
